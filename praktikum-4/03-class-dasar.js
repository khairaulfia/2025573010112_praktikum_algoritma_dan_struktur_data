...
const mhs1 = new Mahasiswa('fika yunita', '2025573010012', 'Informatika'); 
const mhs2 = new Mahasiswa('amara imanika',  '2025573010042', 'Sistem Informasi'); 
const mhs3 = new Mahasiswa('adila salsabila',  '2025573010106', 'Informatika'); 
...
const akun1 = new BankAccount("Khaira", 100000000);
const akun2 = new BankAccount("seungkwan", 500000000);
